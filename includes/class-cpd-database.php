...
class CPD_Database {
    ...
    public function create_prospects_table() {
        ...
        $sql = "CREATE TABLE IF NOT EXISTS {$table_name} (
            ...
            email_verified TINYINT(1) DEFAULT 0 AFTER contact_email,
            email_verification_status VARCHAR(50) NULL AFTER email_verified,
            email_quality VARCHAR(50) NULL AFTER email_verification_status,
            email_verified_at DATETIME NULL AFTER email_quality,
